...
namespace ConsoleApp3
{
    internal class ExcelentPupil : Pupil
    {
        ...
        public override void Read() => Console.WriteLine($"{LastName} читает очень быстро!");
        public override void Write() => Console.WriteLine($"{LastName} пишет без ошибок!");
        public override void Relax() => Console.WriteLine($"{LastName} отдыхает, играя в шахматы!");
